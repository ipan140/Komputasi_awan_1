...
if (!$obj->ViewById($_GET['id_siswa'])) {
    die("Error : NIM Mahasiswa Tidak Ada");
}

if ($_SERVER['REQUEST_METHOD'] == 'POST') {

    if ($obj->DeleteById($obj->id_siswa)) {
        echo '<div> SUKSES </div>';
    ...
    <div class="container">
        <section class="">
            ...
            <div class="HapusSiswaByNim">
                ...
                <h1><?php echo $obj->nama; ?> (<?php echo $obj->id_siswa; ?> )</h1>
                ...
                <div class="Delete" id="popup">
                    <form class="Del-In" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
                        ...
                        <a class="btn-back-delete" href="./member.php">Kembali</a>
                    </form>
                </div>
            </div>
        </section>
